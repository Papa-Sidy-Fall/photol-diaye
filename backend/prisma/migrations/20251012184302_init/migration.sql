...
CREATE TABLE `VIPPoints` (
    ...
    UNIQUE INDEX `VIPPoints_productId_key`(`productId`),
    UNIQUE INDEX `VIPPoints_userId_key`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `VIPPoints` ADD CONSTRAINT `VIPPoints_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `Product`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `VIPPoints` ADD CONSTRAINT `VIPPoints_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
